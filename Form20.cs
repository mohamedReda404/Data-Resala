...
namespace Data_Resala
{
    public partial class Form20 : Form
    {
        ...
        private void SaveData(string name, string status, string nationalID, string maritalStatus, string phone1, string phone2, string area, string address, string explorationDate, string evaluationDate, string evaluation)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    // SQL query to insert the data into the t20 table
                    string query_t20 = "INSERT INTO t20 (الاسم,الحالة,الرقم_القومي,الحالة_الاجتماعية,الهاتف_1,الهاتف_2,المنطقة,العنوان_بالتفصيل,تاريخ_الاستكشاف,تاريخ_التقييم,التقييم) "
                                       + "VALUES (@Name, @Status, @NationalID, @MaritalStatus, @Phone1, @Phone2, @Area, @Address, @ExplorationDate, @EvaluationDate, @Evaluation)";

                    using (SqlCommand cmd = new SqlCommand(query_t20, conn))
                    {
                        ...
                        // Execute the query to insert into t20
                        cmd.ExecuteNonQuery();
                    }
                   ...
                   // string selectedText = comboBox4.SelectedItem?.ToString();
                    ...
                    if (selectedText != null && selectedText.Contains("طبي"))
                    {
                        string query3 = "INSERT INTO tty1 (الاسم,الحالة,الرقم_القومي,الحالة_الاجتماعية,الهاتف_1,الهاتف_2,المنطقة,العنوان_بالتفصيل,تاريخ_الاستكشاف,تاريخ_التقييم,التقييم) " +
                              "VALUES (@Name, @Status, @NationalID, @MaritalStatus, @Phone1, @Phone2, @Area, @Address, @ExplorationDate, @EvaluationDate, @Evaluation)";
                    ...
                    if (selectedText_2 != null && selectedText_2.Contains("أرشيف"))
                    {
                    ...
                    if (selectedText != null && selectedText.Contains("زيارات"))
                    {
                        string query11 = "INSERT INTO table_11t (الاسم,الحالة,الرقم_القومي,الحالة_الاجتماعية,الهاتف_1,الهاتف_2,المنطقة,العنوان_بالتفصيل,تاريخ_الاستكشاف,تاريخ_التقييم,التقييم) " +
                              "VALUES (@Name, @Status, @NationalID, @MaritalStatus, @Phone1, @Phone2, @Area, @Address, @ExplorationDate, @EvaluationDate, @Evaluation)";
                    ...
                    if (selectedText != null && selectedText.Contains("عرايس"))
                    {
                        string query11 = "INSERT INTO table_12t (الاسم,الحالة,الرقم_القومي,الحالة_الاجتماعية,الهاتف_1,الهاتف_2,المنطقة,العنوان_بالتفصيل,تاريخ_الاستكشاف,تاريخ_التقييم,التقييم) " +
                              "VALUES (@Name, @Status, @NationalID, @MaritalStatus, @Phone1, @Phone2, @Area, @Address, @ExplorationDate, @EvaluationDate, @Evaluation)";
                    ...
                    if (selectedText != null && selectedText.Contains("أجهزه طبية"))
                    {
                        string query11 = "INSERT INTO table_13t (الاسم,الحالة,الرقم_القومي,الحالة_الاجتماعية,الهاتف_1,الهاتف_2,المنطقة,العنوان_بالتفصيل,تاريخ_الاستكشاف,تاريخ_التقييم,التقييم) " +
                              "VALUES (@Name, @Status, @NationalID, @MaritalStatus, @Phone1, @Phone2, @Area, @Address, @ExplorationDate, @EvaluationDate, @Evaluation)";
                    ...
                    if (selectedText != null && selectedText.Contains("شنط شهرية"))
                    {
                        string query11 = "INSERT INTO table_14t (الاسم,الحالة,الرقم_القومي,الحالة_الاجتماعية,الهاتف_1,الهاتف_2,المنطقة,العنوان_بالتفصيل,تاريخ_الاستكشاف,تاريخ_التقييم,التقييم) " +
                              "VALUES (@Name, @Status, @NationalID, @MaritalStatus, @Phone1, @Phone2, @Area, @Address, @ExplorationDate, @EvaluationDate, @Evaluation)";
                    ...
                    if (selectedText != null && selectedText.Contains("شنط موسمية"))
                    {
                        string query11 = "INSERT INTO table_15t (الاسم,الحالة,الرقم_القومي,الحالة_الاجتماعية,الهاتف_1,الهاتف_2,المنطقة,العنوان_بالتفصيل,تاريخ_الاستكشاف,تاريخ_التقييم,التقييم) " +
                              "VALUES (@Name, @Status, @NationalID, @MaritalStatus, @Phone1, @Phone2, @Area, @Address, @ExplorationDate, @EvaluationDate, @Evaluation)";
                    ...
                    if (selectedText != null && selectedText.Contains("أيتام"))
                    {
                        string query11 = "INSERT INTO table_16t (الاسم,الحالة,الرقم_القومي,الحالة_الاجتماعية,الهاتف_1,الهاتف_2,المنطقة,العنوان_بالتفصيل,تاريخ_الاستكشاف,تاريخ_التقييم,التقييم) " +
                              "VALUES (@Name, @Status, @NationalID, @MaritalStatus, @Phone1, @Phone2, @Area, @Address, @ExplorationDate, @EvaluationDate, @Evaluation)";
        ...
        {
            dataGridView22.AllowUserToOrderColumns = true;
            //   dataGridView22.Sort(dataGridView22.Columns["ID"], System.ComponentModel.ListSortDirection.Ascending);
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    conn.Open();
                    string query = "SELECT * FROM t20"; // Query to get all data
                ...
                int rowCount = dataGridView22.Rows.Count;
              //  MessageBox.Show($"عدد السجلات بعد الترتيب: {rowCount}");
            }
            catch (Exception ex)
            {
      ...
      //حذف==================================================================
        ...
        private void DeleteData(string nationalID)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "DELETE FROM t20 WHERE الرقم_القومي = @NationalID";
                        ...
                        string explorationDate, string evaluationDate, string evaluation)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "UPDATE t20 SET الاسم = @Name, الحالة = @Status, الحالة_الاجتماعية = @MaritalStatus, " +
        ...
        {
            if (e.RowIndex >= 0)  // تحقق من أن السطر المحدد ليس رأس الجدول
            {
                ...
                // تخزين قيمة الرقم القومي أو أي معرف آخر لاستخدامه في عملية التعديل
               textBox3.Text = row.Cells["الرقم_القومي"].Value.ToString();  // تخزين الرقم القومي
            }
        }
        ...
        private void Form20_Load_1(object sender, EventArgs e)
        {
            LoadData();
        }
        ...
        {
            // الحصول على القيم المدخلة في حقول البحث
            /* string nameToSearch = textBox1.Text;
             string nationalIDToSearch = textBox2.Text;
             string areaToSearch = textBox3.Text;
             string evaluationToSearch = textBox4.Text;*/
                                          ...
                                          string explorationDate, string evaluationDate, string evaluation)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT * FROM t20 WHERE 1 = 1"; // استخدام 1 = 1 كقاعدة ثابتة لجعل شروط البحث مرنة
